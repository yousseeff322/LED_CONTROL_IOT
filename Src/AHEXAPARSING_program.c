...
#include "AHEXAPARSING_Interface.h"
#include "AHEXAPARSING_Private.h"
#include "AHEXAPARSING_Config.h"
...
void Hexa_voidParseData(u8 *Copy_u8DataPtr)
{
	...
	FPEC_voidFlashWrite(Global_u32FullAddress, Global_u16DataBuffer, (Local_u8CCTotal/2));
}
